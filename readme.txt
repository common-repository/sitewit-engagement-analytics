...
2. Search for "Search Engine Marketing" and click then 'Install Now' to install the plugin.
3. Activate the plugin and navigate to Settings > Search Engine Marketing sub-menu.
...
= 2.4.5 =
* Minor fix for possible PHP 5.3 compatibility
...
= 2.4.1 =
* Fix schema updater
* Better text translation support
...
= 2.1.3 =
* Make sure the plugin is updated to be compatible with latest WordPress version
